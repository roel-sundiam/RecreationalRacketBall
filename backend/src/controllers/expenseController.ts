...
export const getAllExpenses = asyncHandler(
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    const [expenses, total] = await Promise.all([
      Expense.find(query).sort(sort).skip(skip).limit(Number(limit)).lean(),
...
export const createExpense = asyncHandler(
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    console.log(
      `💰 New expense created: ₱${amount} - ${details} (${category}) by ${createdBy}`,
    );
...
export const updateExpense = asyncHandler(
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    console.log(
      `✏️ Expense updated: ${id} - ₱${amount} - ${details} by ${req.user?.username}`,
    );
...
export const deleteExpense = asyncHandler(
  async (req: AuthenticatedRequest, res: Response) => {
    ...
    console.log(
      `🗑️ Expense deleted: ${id} - ₱${expense.amount} - ${expense.details} by ${req.user?.username}`,
    );
