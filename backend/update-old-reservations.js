  ...
  try {
    ...
    for (const reservation of reservations) {
      ...
      const isOldFormat =
        ...
        typeof reservation.players[0] === "string";
      ...
      console.log(
        `   💰 Pricing: ${pricingModel}, Base: ₱${totalBaseFee}, Member share: ₱${memberShare}`,
      );
      ...
      for (const member of members) {
        ...
        console.log(
          `   💳 Created payment: ₱${paymentAmount} (${paymentStatus}) for ${member.name || "member"}`,
        );
      }
      ...
      console.log(
        `   ✅ Updated reservation with ${paymentIds.length} payments`,
      );
    }
