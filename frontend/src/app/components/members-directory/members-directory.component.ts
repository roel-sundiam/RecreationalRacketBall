      ...
      <div class="page-content">
        ...
        <div class="filters-card">
          ...
          <div class="active-filters" *ngIf="hasActiveFilters()">
            ...
            <mat-chip-set>
              <mat-chip
                *ngIf="filterForm.get('gender')?.value"
              ...
              <mat-chip
                *ngIf="
                  filterForm.get('approved')?.value !== null &&
                  filterForm.get('approved')?.value !== ''
                "
            ...
            <button mat-button (click)="clearAllFilters()" class="clear-all-btn">Clear All</button>
          </div>
        </div>
        ...
        <div class="members-content" *ngIf="!loading && !error && memberData">
            ...
            <div class="member-card" *ngFor="let member of memberData.data">
              ...
              <div class="card-content">
                <div class="member-details">
                  ...
                  <div
                    class="detail-item"
                    *ngIf="(isAdmin || canViewContact(member)) && member.phone"
                  >
              ...
              <div class="card-actions">
                <button
                  mat-raised-button
                  color="primary"
                  (click)="viewMemberProfile(member._id)"
          ...
          <div
            ...
            *ngIf="memberData?.pagination && memberData.pagination.totalPages > 1"
          >
            <mat-paginator
...
export class MembersDirectoryComponent implements OnInit, OnDestroy {
  ...
  loadMembers(): void {
    ...
    Object.keys(params).forEach((key) => {
      if (
        params[key as keyof MemberSearchParams] === '' ||
        params[key as keyof MemberSearchParams] === null
      ) {
  ...
  canContact(member: Member): boolean {
    return member._id !== this.authService.currentUser?._id && member.isApproved && member.isActive;
  }
